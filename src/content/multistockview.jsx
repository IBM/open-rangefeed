...
export default class MultiStockView extends React.Component {
  ...
  render() {
    ...
    const {
      stockStartingPrice1, stockStartingPrice2, stockStartingPrice3, stockStartingPrice4,
      companyName1, companyName2, companyName3, companyName4,
      companyName1Img, companyName2Img, companyName3Img, companyName4Img,
      stockModifier1, stockModifier2, stockModifier3, stockModifier4,
    } = this.state;
